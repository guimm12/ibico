...
<!-- Barra de Navegação -->
 ...
 <!-- SEGUNDO CARD - BUSCAR PEDIDOS - GUIA PEDIDOS (CRIADO UM CARD COM OS DADOS DE BUSCA) --> 
  ...
  <div id="cardpedidos" class="card-panel z-depth-5">
		...
		<button class="btn blue modal-trigger" type="submit" name="action" href="#modalcriarpedido">Criar Pedido
		</button>
			...
			<div id="card-widgets">
                 ...
                 <div class="col s12 m4 l4">
                  <ul id="task-card" class="collection with-header">
                    <li class="collection-header teal accent-4">
                      <h4 class="task-card-title">Pedido 01</h4>
              ...
              <div class="row">
                <div class="col s12 m4 l4">
                  <ul id="task-card" class="collection with-header">
                    <li class="collection-header teal accent-4">
                      <h4 class="task-card-title">Pedido 02</h4>
                      <p class="task-card-date">27/05/18</p>
                    </li>
                    <li class="collection-item dismissable">
                       <!-- Colocar conteúdo --> 
			   ...
			   <div class="col s12 m4 l4">
                  <ul id="task-card" class="collection with-header">
                    <li class="collection-header teal accent-4">
                      <h4 class="task-card-title">Pedido 03</h4>
                      <p class="task-card-date">27/05/18</p>
                    </li>
				...
				<!-- Quarto CARD de Teste -->
				 ...
				 <div class="col s12 m4 l4">
                  <ul id="task-card" class="collection with-header">
                    <li class="collection-header teal accent-4">
                      <h4 class="task-card-title">Pedido 04</h4>
                      <p class="task-card-date">27/05/18</p>
                    </li>
                    <li class="collection-item dismissable">
                       <!-- Colocar conteúdo --> 
