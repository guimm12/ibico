 ...
 // conecta-se automaticamente ao servidor MySQL
 	...
 	class usuario{
 		...
 		public function VerificaUsuario()
 		{
 			...
 			return "Nome: $this->nm_nome sobrenome: $this->nm_sobrenome Telefone: $this->cd_telefone_fixo Celular: $this->cd_telefone_movel $this->nm_email Sexo: $this->sx_sexo Senha $this->cd_senha ";
