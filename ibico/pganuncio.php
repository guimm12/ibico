...
<!-- Barra de Navegação -->
 ...
 <!-- CARD - BUSCAR ANÚNCIOS- GUIA ANÚNCIOS(CRIADO UM CARD COM OS DADOS DE BUSCA) --> 
  ...
  <div id="cardpedidos" class="card-panel z-depth-5">
		...
		<h4 class="blue-text text-blue center-align" >Profissional</h4>	 
		...
		<div class="row">
	  	 ...
	  	 <span class="card-title grey-text text-darken-4">Alberto<i class="mdi-navigation-close right"></i></span>
										...
										<p><i class="mdi-action-wallet-travel cyan-text text-darken-2"></i>Formação: Técnico em Informática</p>
...
</div><button class="btn blue" type="submit" name="action">Avaliar Usuário
										</button>
 </form>
</div>
						...
						<li class="collection-header">
								...
								<div id="profile-card" class="card">
									...
									<div class="card-content">
                                        ...
                                        <p><i class="mdi-image-navigate-next cyan-text text-darken-2"></i>Realizo serviços gerais de informática, formatação, backup, troca de componentes e muito mais!</p>
