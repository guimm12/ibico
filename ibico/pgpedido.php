...
<!-- Barra de Navegação -->
        ...
        <div class="container">
		   ...
		   <!-- <img src="img/logo.png" widht="62px" height="62px"></a> -->
				...
				<!-- Estrutura Dropdown de Anúncios (o que vem depois que você clica em anúncios/pedidos/avaliações - Dropdown Structure -->
					...
					<li><a class="modal-trigger" type="submit" name="action" href="#modalcriaranuncio">Criar anúncio</a></li>
 ...
 <!-- CARD - BUSCAR ANÚNCIOS- GUIA ANÚNCIOS(CRIADO UM CARD COM OS DADOS DE BUSCA) --> 
  ...
  <div id="cardpedidos" class="card-panel z-depth-5">
		...
		<h4 class="blue-text text-blue center-align" >Cliente</h4>	 
		...
		<div class="row">
	  	 ...
	  	 <span class="card-title grey-text text-darken-4">Coletto<i class="mdi-navigation-close right"></i></span>
										
										 <img src="img/avatar1.jpg" alt="" class="circle responsive-img activator card-profile-image">
                                        
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i>Coletto Ferreira</p>
                                        <p><i class="mdi-action-perm-phone-msg cyan-text text-darken-2"></i> (13) 99163-6099</p>
                                        <p><i class="mdi-communication-email cyan-text text-darken-2"></i> colettocliente@hotmail.com</p>
                                       
                                        <p><i class="mdi-social-location-city cyan-text text-darken-2"></i>Cidade: São Vicente - SP</p>
										<p><i class="mdi-social-location-city cyan-text text-darken-2"></i>Bairro: Centro</p>
			...
			<img src="img/star0.png" id="s5"></a>
										...
										</div><button class="btn blue" type="submit" name="action">Mostrar Interesse
										</button>
 </form>
</div>
					...
					<li class="collection-header">
								...
								<div id="profile-card" class="card">
									...
									<div class="card-content">
                                        <a class="waves-effect waves-light darken-2 right">
                                         <i class="mdi-action-account-circle"></i>
                                        </a>

                                        <span class="card-title activator grey-text text-darken-4">Necessito de restauro na parede!</span>
										
                                        <p><i class="mdi-image-navigate-next cyan-text text-darken-2"></i>Por conta de uma infiltração a parede da sala acabou descascando, necessita rebocar e pintar!</p>
      ...
      <div class="modal-content">
        <div class="container">
          ...
          <div class="row">
            ...
            <label for="textarea2">Descreva seu anúncio (ex. formação, certificações, tempo de experiência, etc)</label>
