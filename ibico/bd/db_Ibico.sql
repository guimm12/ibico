...
select * from tb_usuario where nm_email = 'teste@teste'; 
...
create table tb_tag
(
	cd_tag int not null auto_increment,
	nm_tag varchar(100),
...
(
	cd_anuncio_tag int not null auto_increment,
	cd_anuncio int,
	cd_tag int,
...
(
	cd_pedido_tag int not null auto_increment,
	cd_pedido int,
	cd_tag int,
...
(
	cd_pedido_resposta int not null auto_increment,
	cd_pedido int,
