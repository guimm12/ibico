...
<!-- Barra de Navegação -->
 ...
 <!-- CARD - BUSCAR ANÚNCIOS- GUIA ANÚNCIOS(CRIADO UM CARD COM OS DADOS DE BUSCA) --> 
  ...
  <div id="cardmeuspedidos" class="card-panel z-depth-5 col s12 m12 light-blue">
        ...
        <a href="#!" class="collection-item">Máquina de lavar quebrou</a>
        <a href="#!" class="collection-item">Procuro mecânico de confiança</a>
        <a href="#!" class="collection-item">Procuro pessoa que conserta tela de Smartphone</a>
		<a href="#!" class="collection-item">Orçamento de móveis planejados</a>
        <a href="#!" class="collection-item">Orçamento de construção de piscina</a>
		<a href="#!" class="collection-item">Orçamento de móveis planejados</a>
        <a href="#!" class="collection-item">Orçamento de construção de piscina</a>
		<a href="#!" class="collection-item">Orçamento de móveis planejados</a>
        <a href="#!" class="collection-item">Orçamento de construção de telhado</a>
		<a href="#!" class="collection-item">Orçamento de grafiato</a>
        <a href="#!" class="collection-item">Orçamento de construção de porão</a>
					...
					<li class="collection-header light-blue">
								...
								<div id="profile-card" class="card">
									...
									<div class="card-reveal">
                                        ...
                                        <p>Tive um problema de infiltração na parede, necessito de restauração e pintura.</p>
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i>Vinicius Eduardo</p>
                                        <p><i class="mdi-action-perm-phone-msg cyan-text text-darken-2"></i> (13) 99163-6099</p>
                                        <p><i class="mdi-communication-email cyan-text text-darken-2"></i> vinicius@hotmail.com</p>
                                        <p><i class="mdi-image-navigate-next cyan-text text-darken-2"></i>Categoria: Reformas e Serviços Gerais</p>
				 ...
				 <div class="col s12 m6 l4">
				  <ul id="task-card" class="collection with-header">
					...
					<img src="img/star0.png" id="s5"></a>
					 ...
					 <li><i class="mdi-action-perm-identity cyan-text text-darken-2"></i>José Carlos
                    ...
                    <li><i class="mdi-image-navigate-next cyan-text text-darken-2"></i>Categoria: Reformas e Serviços Gerais</li>
					 <li><i class="mdi-action-wallet-travel prefix cyan-text text-darken-2"></i>Formação: Pedreiro Geral</li>
